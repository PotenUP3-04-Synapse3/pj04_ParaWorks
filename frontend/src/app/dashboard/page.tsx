...
export default async function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <p className="text-sm font-medium text-muted">전체 현황</p>
      ...
      <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-md border border-line bg-white p-4">
          <div className="flex items-center justify-between">
            <span className="text-sm font-medium text-muted">출처</span>
        ...
        <div className="rounded-md border border-line bg-white p-4">
          <div className="flex items-center justify-between">
            <span className="text-sm font-medium text-muted">검토 대기</span>
        ...
        <div className="rounded-md border border-line bg-white p-4">
          <div className="flex items-center justify-between">
            <span className="text-sm font-medium text-muted">최근 작업</span>
        ...
        <div className="rounded-md border border-line bg-white">
          ...
          <div className="divide-y divide-line">
            ...
            {dashboard.recent_jobs.length === 0 ? (
              <p className="px-4 py-8 text-sm text-muted">아직 실행된 동기화 작업이 없습니다.</p>
            ) : null}
          </div>
        </div>
        ...
        <div className="rounded-md border border-line bg-white">
          ...
          <div className="divide-y divide-line">
            ...
            {Object.keys(dashboard.source_counts).length === 0 ? (
              <p className="px-4 py-8 text-sm text-muted">아직 색인된 출처가 없습니다.</p>
            ) : null}
          </div>
        </div>
      </section>
